  ...
  >
    ...
    <div class="sidebar-icon group">
      ...
      <span class="sidebar-tooltip group-hover:scale-100"
        >Accounts<router-link to="/"></router-link
      ></span>
    </div>
    ...
    <div class="sidebar-icon group">
      ...
      <span class="sidebar-tooltip group-hover:scale-100">Opportunities</span>
    </div>
    <div class="sidebar-icon group">
      ...
      <span class="sidebar-tooltip group-hover:scale-100">Artifacts</span>
    </div>
    ...
    <div class="sidebar-icon group">
      ...
      <span class="sidebar-tooltip group-hover:scale-100">Contacts</span>
    </div>

    <div class="sidebar-icon group">
      <router-link to="/tasks">
        <svg
          id="rectangle-stack-icon"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          stroke-width="2"
      ...
      <span class="sidebar-tooltip group-hover:scale-100">Tasks</span>
    </div>

    <div class="sidebar-icon group">
      <router-link to="/notes">
        <svg
          id="pencil-square-icon"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          stroke-width="2"
      ...
      <span class="sidebar-tooltip group-hover:scale-100">Notes</span>
    </div>
